{
  home.file."amethyst/amethyst.yml".text = ''
    ...
    ## Move focus to the n-th screen in the list; e.g., focus-screen-3 will move mouse focus to the 3rd screen.
    # The main window in the given screen will be focused.
